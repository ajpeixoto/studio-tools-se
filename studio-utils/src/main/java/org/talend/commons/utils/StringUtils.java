...
public class StringUtils {
    ...
    private static String loadConvert(char[] in, int off, int len, char[] convtBuf, char preHex) {
        ...
        if (preHex == 'u') {
            ...
            throw new IllegalArgumentException("only support the \\uxxxx or \\xhh encoding."); //$NON-NLS-1$
        }
                    ...
                    if (aChar == 't') {
                        ...
                        for (int i = 0; i < 3; i++) {
                            ...
                            case '7':
                                ...
                                break;
                            default:
                                throw new IllegalArgumentException("Malformed \\0xxx encoding."); //$NON-NLS-1$
                            }
